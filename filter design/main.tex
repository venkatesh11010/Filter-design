...
\begin{figure}[H]
\includegraphics[width = 0.9\columnwidth]{figs/pole-zero_plot.png}
...
\begin{figure}[H]
\includegraphics[width = 0.8\columnwidth]{figs/hlp.png}
...
\begin{figure}[H]
\includegraphics[width = 0.8\columnwidth]{figs/Hlp-real.png}
...
\begin{figure}[H]
\includegraphics[width = 0.85\columnwidth]{figs/Hbp_impulse.png}
\caption{The impulse response of the FIR bandpass digital filter designed to meet the given specifications}
\label{fig9}
\end{figure}

\begin{figure}[H]
\includegraphics[width = 0.85\columnwidth]{figs/Hbp_frequency.png}
